...
void LegController<T>::updateData(const SpiData* spiData) {
  for (int leg = 0; leg < 4; leg++) {
    ...
    // output two legs' joint data
//    if(leg==0) {
//        std::ofstream outfile("/home/allen/joint0.txt",ios::app);
//        outfile << "  abad:  " << datas[leg].q(0);
//        outfile << "  hip:   " << datas[leg].q(1);
//        outfile << "  knee:  " << datas[leg].q(2) << std::endl;
//    }
//    if(leg==2) {
//          std::ofstream outfile("/home/allen/joint1.txt",ios::app);
//          outfile << "  abad:  " << datas[leg].q(0);
//          outfile << "  hip:   " << datas[leg].q(1);
//          outfile << "  knee:  " << datas[leg].q(2) << std::endl;
//    }
