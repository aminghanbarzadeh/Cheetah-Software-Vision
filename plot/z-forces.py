...
# Plot Z forces for all legs
plt.figure(figsize=(10, 6))
plt.plot(force_data['time'], force_data['leg_1_z_force'], label='Leg 1', color='blue')
plt.plot(force_data['time'], force_data['leg_2_z_force'], label='Leg 2', color='orange')
plt.plot(force_data['time'], force_data['leg_3_z_force'], label='Leg 3', color='green')
plt.plot(force_data['time'], force_data['leg_4_z_force'], label='Leg 4', color='red')
