...
/*!
 * Configure the window for displaying IUST robot
 */
size_t Graphics3D::setupIUST(Vec4<float> color, bool useOld, bool canHide) { return _drawList.addIUST(color, useOld, canHide); }
